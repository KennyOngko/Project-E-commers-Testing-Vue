      ...
      <q-toolbar>
        ...
        <div v-else style="display:flex; max-width:100%;">
            <q-btn-dropdown color="primary" :label="LocalStorage.getItem('Kenny').user.name">
              <q-list>
                <div>
                  <q-item clickable v-close-popup @click="changePage('/')">
                    <q-item-section>
...
const linksData = [
  ...
  },
  {
    ...
    caption: 'Add, Update, Delete Product',
    icon: 'code',
    link: 'http://localhost:8080/#/admin/manageProduct'
  },
  {
    title: 'Manage category',
    caption: 'Add, Update, Delete Category',
    icon: 'chat',
    link: 'http://localhost:8080/#/'
  },
]
